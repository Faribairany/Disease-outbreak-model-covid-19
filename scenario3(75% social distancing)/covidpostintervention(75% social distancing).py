...
FINAL_SLIQRD = open("covid_19(postintervention(75%)).csv", "w")  # open file for writing
FINAL_SLIQRD.write("time, Susceptible, Socially_distanced, Exposed, Infectious, Hospitalized, Isolation_treated, Recovered, R0SD\n")  # write headers to file

for i in range(0, 30000):
    FINAL_SLIQRD.write(
        str(t) + "," + str(S) + "," +  str(SD) + "," + str(E) + "," + str(I) + "," + str(J) + "," + str(Q) + "," + str(R) + "," + str(R0SD) + "\n")
